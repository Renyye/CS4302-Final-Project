...
def run_benchmark(transpose_func, label, iterations=1000, size=(2048, 1024)):
...
for func, name in [(custom_ops.custom_transpose_cuda_v1, "Custom transpose_kernel"),
                   (custom_ops.custom_transpose_cuda_v2, "Custom transpose_kernel")]:
